const {src, dest, watch, series} = require('gulp'), // подключаем Gulp
  ...
  include = require('gulp-file-include'), // модуль
  ...
  concat = require('gulp-concat'), // модуль конкатенация (объединение) файлов
...
exports.build = series(clear, styles, templates, scripts, images, webpImg, spriteSVG, fonts);
exports.serve = series(clear, styles, templates, scripts, images, webpImg, spriteSVG, fonts, serve);